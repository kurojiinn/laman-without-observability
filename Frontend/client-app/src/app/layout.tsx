...
export const metadata: Metadata = {
  title: "Yuhher — близкие магазины, быстрая доставка",
  description: "Yuhher — доставка из ближайших магазинов. Продукты, еда, товары — быстро и рядом.",
};
  ...
  return (
    ...
    >
      <head>
        ...
        <meta name="apple-mobile-web-app-title" content="Yuhher" />
